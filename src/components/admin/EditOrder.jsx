...
import { Col, Form, Button, Table, Card, Toast, Image } from "react-bootstrap";
    ...
    <>
      <Card className="col-md-10 col-sm-11 mx-auto mt-4 mb-4">
        ...
        <Card.Body>
          ...
          {/* Toast Daftar Produk */}
          <Button onClick={toggleShowToast}>Daftar Produk</Button>
              ...
              <Table responsive className="col-md-10 col-sm-11 mx-auto">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>
                      <Image src={Laptop} fluid width={100} height={100} />
                    </td>
